...
import { ShoppingCart, User, Package, Menu, X, Search, Home } from 'lucide-react';
...
const createFaker = () => {
  ...
  return {
    person: {
      ...
      email: () => `${pick(firstNames).toLowerCase()}.${pick(lastNames).toLowerCase()}@email.com`,
    },
    commerce: {
      ...
      productDescription: () => 'High-quality product with excellent features and durability.',
    },
    image: {
